"""Example usages for the `choosinator.validation.ValidatingBaseClass` class."""
...
class ActionExample(ValidatingBaseClass):
    """Shows an example usage of the `choosinator.validation.ValidatingBaseClass` class."""
...
def run_example() -> None:
    """An example usage of the `choosinator.validation.ValidatingBaseClass` class.
